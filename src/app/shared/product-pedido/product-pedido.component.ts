...
@Component({
  selector: 'product-pedido',
  templateUrl: './product-pedido.component.html',
  styleUrls: ['./product-pedido.component.scss']
})
export class ProductPedidoComponent implements OnInit {
